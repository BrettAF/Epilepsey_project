...
def fineTuningPipeline(dfs,labels):
  ...
  return fine_tuning_data, prooving_data, fine_tuning_labels, prooving_labels
...
for index,folder in enumerate(folders_for_making_model):
  ...
  os.chdir('..')
  fine_tuning_labels, fine_tuning_files = saveBins(fine_tuning_data,fine_tuning_labels,folder)
  prooving_data_labels, prooving_data_files = saveBins(prooving_data,prooving_labels,folder)
  ...
  #os.chdir('..')
  saveArray(folder,( fine_tuning_labels, fine_tuning_files,prooving_data_labels, prooving_data_files))#,fine_tuning_data, prooving_data, fine_tuning_labels, prooving_labels))
