...
def convertFileToNP(file_name, recording_start_time, data, header):
  ...
  for row in range(0,rowcount,600):
      label_array.append(int(assignLabel( row*.003906 + recording_start_time, seizure_start_times, seizure_end_times ) ))
...
#data,header=convertEDF('chb01_03')

#row_count=convertFileToNP('chb01_03',file_start_times[2], data, header)
